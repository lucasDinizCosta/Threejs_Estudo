 ...
 * --------------------------  Texturas em KTX   ----------------------------------------- *
 *                                                                                         *
 *      Khronos Texture (KTX) é uma textura com base no WebGL.                             *
 *      Este tipo de arquivo é focado em texturas comprimidas para ser diretamente proces- *
 * -sadas pelo WebGL com a menor sobrecarga de processamento.                              *
 *      As texturas no formato KTX geralmente vêm com codificação diferente e, com base no *
 *  suporte do dispositivo, uma codificação diferente pode ser carregada.                  *
 *******************************************************************************************/
