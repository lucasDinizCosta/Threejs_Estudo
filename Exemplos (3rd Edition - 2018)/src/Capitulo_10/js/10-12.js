 ...
 * ------------------------------------------   Light map  -----------------------------------------------  *
 *                                                                                                          * 
 * =>   Light map (mapa de luz): Possibilita a criação de um falso sombreado de modo a melhorar o realismo  *
 * do material. Este tipo de mapeamento é gerado de forma pré-renderizada, portanto só trabalha em cenas    *
 * estáticas.                                                                                               *
 *                                                                                                          *
 ***********************************************************************************************************/
...
function init() {
  ...
  loader.load("../../assets/models/lightmap/lightmap.json", function (sceneGroup) {
    ...
    plane.geometry.faceVertexUvs.push(plane.geometry.faceVertexUvs[0]);     // Fundamental para Light Map
