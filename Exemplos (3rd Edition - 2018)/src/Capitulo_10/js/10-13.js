 ...
 * --------------------------------------------   ENV map  -----------------------------------------------  *
 *                                                                                                          * 
 * =>   ENV map: Permite a simulação de reflexos em objetos.                                                *
 *                                                                                                          *
 ***********************************************************************************************************/
function init() {
  ...
  var cubeLoader = new THREE.CubeTextureLoader();           // Cria uma estrutura dando a entender de uma foto 360 graus
  ...
  var cubeMaterial = new THREE.MeshStandardMaterial({
      envMap: scene.background,                         //Reflexão
