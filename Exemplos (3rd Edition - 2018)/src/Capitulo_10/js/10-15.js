 ...
 * ------------------------------------------   Emission map  --------------------------------------------  *
 *                                                                                                          * 
 * =>   Emission map (Mapa de emissão): Ideal para texturas que tenham um certo brilho. A luz externa tem   *
 * forte influencia no brilho do objeto, pode então ver o seu comportamente em baixa luminosidade.          *
 *                                                                                                          *
 ***********************************************************************************************************/
function init() {
