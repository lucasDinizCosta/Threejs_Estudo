/**
 * Não requer bibliotecas extras para trabalhar com JSON
 */
function init() {
    ...
    var controls = new function () {
      ...
      this.save = function () {
        var result = knot.toJSON();                             // Converte os dados do objeto para JSON
      ...
      this.load = function () {
        ...
        var json = localStorage.getItem("json");                // Carrega o objeto JSON
  
        if (json) {                                             // Carregando executado corretamente
          var loadedGeometry = JSON.parse(json);                
          var loader = new THREE.ObjectLoader();                // Carregador de objetos
