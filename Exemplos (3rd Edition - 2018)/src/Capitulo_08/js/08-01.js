function init() {
    ...
    gui.add(controls, "boundingBox").onChange(function (e) {
        controls.positionBoundingBox();
        controls.redraw();
    });
    controls.redraw();
    ...
    function setFromObject(object) {
      ...
      box.makeEmpty();                      // Inicializa este Region para um interior vazio.
      object.traverse(function (node) {
        if (node.geometry !== undefined && node.geometry.vertices !== undefined) {
          ...
          for (var i = 0, il = vertices.length; i < il; i++) {
            ...
            box.expandByPoint(v1);          // Expande os limites desta caixa para incluir o ponto.
          }
        }
      });
      return box;
