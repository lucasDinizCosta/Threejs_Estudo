/**
 * São criados 2 tweens neste projeto:
 *  - Tween: Define como a propriedade "position" transita de 1 para 0
 *  - TweenBack: O oposto.
 * 
 * função chain (): Encadeia os dois tipos de tweens para que comecem o loop quando iniciados;
 * Em onUpdate() percorremos todos os vértices do sistema de partículas e mudamos 
 * de posição de acordo com a posição fornecida pela interpolação (this.pos)
 */
function init() {
