/**
 * Exemplo que utiliza carregamento de imagens: THREE.TextureLoader().load
 */
...
function init() {
    ...
    function createPointCloud(size, transparent, opacity, sizeAttenuation, color) {
      ...
      var material = new THREE.PointsMaterial({
        ...
        opacity: opacity,
        map: texture,                           // Atribui a imagem carregada como textura do material das particulas de chuva
