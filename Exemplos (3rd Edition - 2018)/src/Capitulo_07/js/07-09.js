function init() {
    ...
    function createSprite(size, transparent, opacity, color, spriteNumber) {
      ...
      spriteMaterial.map.offset = new THREE.Vector2(0.2 * spriteNumber, 0);     // Posicão do sprite na imagem
      spriteMaterial.map.repeat = new THREE.Vector2(1 / 5, 1);                  // 5 Fantasmas na spritesheet
